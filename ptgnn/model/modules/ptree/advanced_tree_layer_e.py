...
class AdvancedPermutationEdgeTreeLayer(torch.nn.Module):
    """
    ...
    def forward(
        ...
        temp = batch.layer0_pooling
        for layer_idx in range(1, batch.num_layer):
            temp = batch[f"layer{layer_idx}_pooling"][temp]
