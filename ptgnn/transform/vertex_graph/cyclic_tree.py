...
def cyclic_tree_vertex_light(
        data: torch_geometric.data.Data,
        mol_example
) -> torch_geometric.data.Data:
    """
    Adds cyclic vertices and edges to vertex graph. Light mode: no connection to neighbor rings
...
def cyclic_tree_vertex_minimal(
        data: torch_geometric.data.Data,
        mol_example
) -> torch_geometric.data.Data:
    """
    Adds cyclic vertices and edges to vertex graph. Minimal mode: no connection to neighbor rings and no connection
    of participating nodes/edges to circle.
