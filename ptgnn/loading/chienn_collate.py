"""
Taken/Adapted from Chienn:
https://github.com/gmum/ChiENN/blob/master/chienn/data/featurize.py#L30
https://github.com/gmum/ChiENN/blob/master/chienn/data/edge_graph/collate_circle_index.py#L9
"""
...
def collate_circle_index(batch: List[Data], k_neighbors: int) -> torch.Tensor:
    """
...
def _collate_repeated(circle_index_list: List[List[List[int]]]) -> torch.Tensor:
    """
